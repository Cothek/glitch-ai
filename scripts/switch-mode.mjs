...
async function generateNormalConfig(templateText) {
  const engineInstructions = ['.opencode/instructions/coordinator-instructions.md', 'glitch-memorycore/plugins/glitch-skills/skills-registry.md'];
