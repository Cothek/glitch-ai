...
$safeConfig = @'
{
  ...
  "agent": {
    "delegator": {
      ...
      "prompt": "You are Glitch running in SAFE MODE. Something is broken with the Glitch configuration and Troy needs your help to fix it.
...
$safeConfig | Out-File -FilePath $ConfigPath -Encoding utf8 -Force
