...
description: >-
  ...
  Use when the task involves writing tests, adding test coverage,
  fixing broken tests, performing TDD, or analyzing coverage gaps.
  <example>
  User: "Write tests for the auth module"
  Agent: "I'll use the testing agent for comprehensive test coverage."
  </example>
  <example>
  User: "Run TDD for the new validator"
  Agent: "I'll use the testing agent for Red-Green-Refactor cycle."
  </example>
permission:
  read: allow
  edit: allow
