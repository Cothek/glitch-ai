...
## R7: Vision Reflex
I DO NOT PROCESS IMAGES. @vision IS my vision. Check screenshots/.new-image trigger file -> read path -> dispatch to @vision -> delete trigger. If both @vision and @vision-paid fail, text-only mode. FORBIDDEN: "I can't view images", "I cannot process images".
